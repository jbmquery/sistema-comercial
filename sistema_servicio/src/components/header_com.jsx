...
import { getPendientesCount } from "../api"
...
function HeaderCom() {
  ...
  useEffect(() => {
    getPendientesCount().then(setPendientes)
  }, [])
  ...
  return (
    <header className="flex items-center justify-end py-4 bg-black relative px-4">
      ...
      >
        <img
          src="../src/img/logo_pluvia_blanco.webp"
          alt="Pluvia Café"
      ...
      <div className="dropdown dropdown-bottom dropdown-end">
        <div
          tabIndex={0}
          role="button"
          className="btn btn-square avatar avatar-online rounded-full"
        >
          <svg
