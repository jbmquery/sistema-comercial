...
function ErrorPage() {
  return (
    <div className='flex flex-col justify-center items-center h-screen gap-4 p-8 bg-neutral-800'>
        ...
        <button className="btn md:btn-md w-45 md:w-30 md:w-40 bg-primary mt-5">Volver al Inicio</button>
    </div>
  )
}
